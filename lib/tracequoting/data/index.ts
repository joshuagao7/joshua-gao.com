...
const files: Record<string, () => Promise<{ enc: string }>> = {
  ...
  "web/drawing-assembly__bridges-aligned.json": () => import('./f_web_drawing_assembly_bridges_aligned_json'),
  ...
  "web/drawing-assembly-2__bridges-flush.json": () => import('./f_web_drawing_assembly_2_bridges_flush_json'),
  ...
  "web/force-platform-ground-mylar-and-traces__final.json": () => import('./f_web_force_platform_ground_mylar_and_traces_final_json'),
